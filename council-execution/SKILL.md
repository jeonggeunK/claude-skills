...
```bash
bash C:/Users/user/.claude/claude-council/scripts/run-council.sh --providers=gemini,openai -- "Your question"
```
...
`C:/Users/user/.claude/claude-council/prompts/synthesis.md` and write your synthesis UNDER
